defmodule Tennis.AccountsTest do
  ...
  import Tennis.AccountsFixtures
  alias Tennis.Accounts.{User, UserToken}
  ...
  import Tennis.AccountsFixtures
  alias Tennis.Accounts.{Admin, AdminToken}
  ...
  describe "register_admin/1" do
    ...
    test "registers admins with a hashed password" do
      ...
      {:ok, admin} = Accounts.register_admin(%{email: email, password: valid_admin_password()})
  ...
  describe "change_admin_registration/2" do
    ...
    test "allows fields to be set" do
      ...
      changeset =
        Accounts.change_admin_registration(%Admin{}, %{"email" => email, "password" => password})
