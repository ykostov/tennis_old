defmodule TennisWeb.AdminAuthTest do
  ...
  @remember_me_cookie "_tennis_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TennisWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TennisWeb.Endpoint.subscribe(live_socket_id)
