defmodule Tennis.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Tennis.Repo)
  ...
  """
  def valid_password?(%Tennis.Accounts.Admin{hashed_password: hashed_password}, password)
